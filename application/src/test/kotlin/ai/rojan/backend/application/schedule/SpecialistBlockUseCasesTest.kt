...
class SpecialistBlockUseCasesTest {
    ...
    private val createUseCase = CreateSpecialistBlockUseCase(salonRepository, specialistRepository, blockRepository)
    private val removeUseCase = RemoveSpecialistBlockUseCase(salonRepository, specialistRepository, blockRepository)
